...
const DEFAULTS: Record<(typeof SETTING_KEYS)[number], string> = {
  ...
  "branding.tagline": "Pilote ta marge CopyX sans te ruiner.",
  // Grille actuelle : Basic 10 $ ≈ 6 000 F · Pro 15 $ ≈ 9 000 F
  "pricing.basic_xof": "6000",
  "pricing.pro_xof": "9000",
  "pricing.starter_xof": "17400",
  "pricing.basic_usd": "10",
  "pricing.pro_usd": "15",
